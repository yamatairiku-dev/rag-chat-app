...
**開発環境のリダイレクトURI:**
```bash
ENTRA_REDIRECT_URI=http://localhost:3000/callback
...
# または開発用VM
DIFY_API_URL=https://dev-dify-vm.japaneast.cloudapp.azure.com

# 本番環境
DIFY_API_URL=https://prod-dify-vm.japaneast.cloudapp.azure.com
...
| `PORT` | `3000` | ローカルポート |
| `ENTRA_REDIRECT_URI` | `http://localhost:3000/callback` | HTTP許可 |
| `DIFY_API_URL` | `http://localhost:8000` | ローカルDify |
...
| `ENTRA_REDIRECT_URI` | `https://your-app.azurewebsites.net/callback` | HTTPS必須 |
| `DIFY_API_URL` | `https://prod-dify-vm.japaneast.cloudapp.azure.com` | 本番Dify |
