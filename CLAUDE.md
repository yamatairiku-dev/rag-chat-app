...
- **No linter or formatter is configured** (no ESLint/Prettier/Biome config), and AGENTS.md explicitly says not to introduce new style tools — follow the existing 2-space/double-quote/trailing-comma convention by hand, don't add tooling unless asked.
